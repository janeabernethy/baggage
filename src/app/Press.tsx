...
export const Press = React.memo(({ disableAnimations, pressRef, isMobile, height, width }: { height: number, width: number, disableAnimations: boolean, pressRef: React.RefObject<HTMLDivElement | null>, isMobile: boolean }) => {
    ...
    return <div ref={pressRef} className={isMobile ? styles.pressContainerMobile : styles.pressContainer}>
        ...
        <div ref={prerssItemsRef} className={isMobile ?  styles.pressItemsContainerMobile : styles.pressItemsContainer}>
            ...
            <PressItem itemWidth={itemWidth} itemHeight={itemHeight} isMobile={isMobile} imgSrc="/press/Michigan.png" title="The Michigan Daily" subtitle="SXSW 2025: Animated shorts highlights" link="https://www.michigandaily.com/arts/film/sxsw-2025-animated-shorts-highlights/" />
            ...
            <PressItem itemWidth={itemWidth} itemHeight={itemHeight} isMobile={isMobile} imgSrc="/press/bond.png" title="Bond on Cinema" subtitle="BAGGAGE The Animated Short Film That Will CHANGE Your Perspective with Lucy Davidson" link="https://www.boomplay.com/episode/9145204" />
            <PressItem itemWidth={itemWidth} itemHeight={itemHeight} isMobile={isMobile} imgSrc="/press/tremont.png" title="The Tremont Mail" subtitle="Empathy Takes Flight" link="https://mailnewsgroup.com/tremont/article/2025-03-11/empathy-takes-flight.html" />
            <PressItem itemWidth={itemWidth} itemHeight={itemHeight} isMobile={isMobile} imgSrc="/press/cinema.png" title="cinema.de" subtitle="Interview mit Lucy Davidson zu 'Baggage'" link="https://www.cinema.de/kino/video/interview-mit-lucy-davidson-zu-baggage-323009_vi.html" />
            <PressItem itemWidth={itemWidth} itemHeight={itemHeight} isMobile={isMobile} imgSrc="/press/focus.png" title="FOCUS by 0163 Frames" subtitle="In Conversation: ‘BAGGAGE’ Director, Writer, and Artist Lucy Davidson" link="https://www.0613focus.com/interviews/in-conversation-baggage-director-writer-and-artist-lucy-davidson" />
            <PressItem itemWidth={itemWidth} itemHeight={itemHeight} isMobile={isMobile} imgSrc="/press/sunshine.png" title="Sunshine State Cineplex" subtitle="SXSW Short: BAGGAGE – Stunning Visuals Complement a Sweet Story" link="https://sunshinestatecineplex.com/2025/03/17/sxsw-2025-short-baggage/" />
            <PressItem itemWidth={itemWidth} itemHeight={itemHeight} isMobile={isMobile} imgSrc="/press/weloveshortfilm.png" title="We Love Short Films" subtitle="Lucy Davidson’s BAGGAGE – A Clever and Touching Exploration of  Emotional Burdens and Friendship" link="https://weloveshortfilm.com/2025/03/04/lucy-davidsons-baggage-a-clever-and-touching-exploration-of-emotional-burdens-and-friendship/" />
