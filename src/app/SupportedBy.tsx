    ...
    return (
        <div className={styles.crewContent3} style={{ padding: "50px 0px" }}>
            ...
            <div className={styles.supportedByContainer}>
                ...
                <div className={isMobile ? styles.supportedByMobileSecond : styles.supportedBySecond}>
                    <SupportImg imgName="/supportedBy/vicscreen.jpg" alt="Vic Screen" link="https://vicscreen.vic.gov.au/" />
